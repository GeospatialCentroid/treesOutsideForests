...
## Note: This script is fully operational, but it is incomplete. It simulates the process, but the real classification maps, age distribution and factors need to be added.
