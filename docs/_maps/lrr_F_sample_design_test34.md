---
title: 'LRR F: whole-region sample design (34 test sites)'
crumb: LRR F, 34 test sites
order: 0
partition: test34
partition_label: 34 test sites
map: maps/lrr_F_sample_design_test34.html
...
validate and test the detection model under the 34 test sites partition. Use the
